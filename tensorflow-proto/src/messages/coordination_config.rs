...
impl CoordinationServiceConfig {
    ...
    pub fn get_poll_for_error_from_service_at_startup(&self) -> bool {
        self.poll_for_error_from_service_at_startup
    }
    pub fn clear_poll_for_error_from_service_at_startup(&mut self) {
        self.poll_for_error_from_service_at_startup = false;
    }

    // Param is passed by value, moved
    pub fn set_poll_for_error_from_service_at_startup(&mut self, v: bool) {
        self.poll_for_error_from_service_at_startup = v;
    }
}
...
impl ::protobuf::Message for CoordinationServiceConfig {
        ...
        while !is.eof()? {
            ...
            match field_number {
                ...
                13 => {
                    ...
                    let tmp = is.read_bool()?;
                    self.poll_for_error_from_service_at_startup = tmp;
                },
                _ => {
                    ::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields())?;
                },
    ...
    fn compute_size(&self) -> u32 {
        ...
        if self.poll_for_error_from_service_at_startup != false {
            my_size += 2;
        }
        my_size += ::protobuf::rt::unknown_fields_size(self.get_unknown_fields());
        self.cached_size.set(my_size);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.poll_for_error_from_service_at_startup != false {
            os.write_bool(13, self.poll_for_error_from_service_at_startup)?;
        }
        os.write_unknown_fields(self.get_unknown_fields())?;
        ::std::result::Result::Ok(())
    }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                ...
                |m: &CoordinationServiceConfig| { &m.poll_for_error_from_service_at_startup },
                |m: &mut CoordinationServiceConfig| { &mut m.poll_for_error_from_service_at_startup },
            ));
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    sks\x18\x02\x20\x01(\x05R\x08numTasks\"\xe3\x05\n\x19CoordinationService\
    ...
    \x20\x01(\x08R\x0cforceDisable\x12P\n&poll_for_error_from_service_at_sta\
    rtup\x18\r\x20\x01(\x08R\x20pollForErrorFromServiceAtStartupJ\x04\x08\
    \x06\x10\x07BWZUgithub.com/tensorflow/tensorflow/tensorflow/go/core/prot\
