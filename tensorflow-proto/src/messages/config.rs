...
pub struct ConfigProto {
    ...
    pub pluggable_device_options: ::protobuf::SingularPtrField<GPUOptions>,
...
impl ConfigProto {
    ...
    pub fn get_pluggable_device_options(&self) -> &GPUOptions {
        self.pluggable_device_options.as_ref().unwrap_or_else(|| <GPUOptions as ::protobuf::Message>::default_instance())
    }
    pub fn clear_pluggable_device_options(&mut self) {
        self.pluggable_device_options.clear();
    }

    pub fn has_pluggable_device_options(&self) -> bool {
        self.pluggable_device_options.is_some()
    }

    // Param is passed by value, moved
    pub fn set_pluggable_device_options(&mut self, v: GPUOptions) {
        self.pluggable_device_options = ::protobuf::SingularPtrField::some(v);
    }

    // Mutable pointer to the field.
    // If field is not initialized, it is initialized with default value first.
    pub fn mut_pluggable_device_options(&mut self) -> &mut GPUOptions {
        if self.pluggable_device_options.is_none() {
            self.pluggable_device_options.set_default();
        }
        self.pluggable_device_options.as_mut().unwrap()
    }

    // Take field
    pub fn take_pluggable_device_options(&mut self) -> GPUOptions {
        self.pluggable_device_options.take().unwrap_or_else(|| GPUOptions::new())
    }
...
impl ::protobuf::Message for ConfigProto {
    fn is_initialized(&self) -> bool {
        ...
        for v in &self.pluggable_device_options {
            if !v.is_initialized() {
                return false;
            }
        };
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        while !is.eof()? {
            ...
            match field_number {
                ...
                18 => {
                    ::protobuf::rt::read_singular_message_into(wire_type, is, &mut self.pluggable_device_options)?;
                },
                7 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
    ...
    fn compute_size(&self) -> u32 {
        ...
        if let Some(ref v) = self.pluggable_device_options.as_ref() {
            let len = v.compute_size();
            my_size += 2 + ::protobuf::rt::compute_raw_varint32_size(len) + len;
        }
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_singular_ptr_field_accessor::<_, ::protobuf::types::ProtobufTypeMessage<GPUOptions>>(
                ...
                |m: &ConfigProto| { &m.pluggable_device_options },
                |m: &mut ConfigProto| { &mut m.pluggable_device_options },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
...
impl ConfigProto_Experimental {
    ...
    pub fn get_tfrt_use_ifrt(&self) -> bool {
        self.tfrt_use_ifrt
    }
    pub fn clear_tfrt_use_ifrt(&mut self) {
        self.tfrt_use_ifrt = false;
    }

    // Param is passed by value, moved
    pub fn set_tfrt_use_ifrt(&mut self, v: bool) {
        self.tfrt_use_ifrt = v;
    }
...
impl ::protobuf::Message for ConfigProto_Experimental {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::ProtobufResult<()> {
        ...
        if self.tfrt_use_ifrt != false {
            os.write_bool(32, self.tfrt_use_ifrt)?;
        }
        if self.backend_server_port != 0 {
    ...
    fn descriptor_static() -> &'static ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| {
            ...
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeBool>(
                "tfrt_use_ifrt",
                |m: &ConfigProto_Experimental| { &m.tfrt_use_ifrt },
                |m: &mut ConfigProto_Experimental| { &mut m.tfrt_use_ifrt },
            ));
            fields.push(::protobuf::reflect::accessor::make_simple_field_accessor::<_, ::protobuf::types::ProtobufTypeInt32>(
                "backend_server_port",
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12P\n\x18pluggable_device_options\x18\x12\x20\x01(\x0b2\x16.tensorflow\
    .GPUOptionsR\x16pluggableDeviceOptions\x120\n\x14allow_soft_placement\
    \x18\x07\x20\x01(\x08R\x12allowSoftPlacement\x120\n\x14log_device_placem\
    ent\x18\x08\x20\x01(\x08R\x12logDevicePlacement\x12=\n\rgraph_options\
    ...
    nAutotunerThresh\x12\x19\n\x08use_tfrt\x18\x12\x20\x01(\x08R\x07useTfrt\
    \x12*\n\x11enable_multi_host\x18\x1b\x20\x01(\x08R\x0fenableMultiHost\
    \x12\"\n\rtfrt_use_ifrt\x18\x20\x20\x01(\x08R\x0btfrtUseIfrt\x12.\n\x13b\
    ackend_server_port\x18\x1c\x20\x01(\x05R\x11backendServerPort\x12\x1d\n\
    \ntarget_tpu\x18\x1d\x20\x01(\x08R\ttargetTpu\x12\x1d\n\ntarget_gpu\x18\
    \x1e\x20\x01(\x08R\ttargetGpu\x124\n\x16stream_merge_threshold\x18\x1f\
    \x20\x01(\x05R\x14streamMergeThreshold\x12E\n\x1fdisable_functional_ops_\
    lowering\x18\x15\x20\x01(\x08R\x1cdisableFunctionalOpsLowering\x12D\n\
    \x1fxla_prefer_single_graph_cluster\x18\x16\x20\x01(\x08R\x1bxlaPreferSi\
    ngleGraphCluster\x12V\n\x13coordination_config\x18\x17\x20\x01(\x0b2%.te\
    nsorflow.CoordinationServiceConfigR\x12coordinationConfig\x12H\n!disable\
    _optimize_for_static_graph\x18\x18\x20\x01(\x08R\x1ddisableOptimizeForSt\
    aticGraph\x12V\n(disable_eager_executor_streaming_enqueue\x18\x1a\x20\
    \x01(\x08R$disableEagerExecutorStreamingEnqueue\"\xde\x01\n\x11MlirBridg\
